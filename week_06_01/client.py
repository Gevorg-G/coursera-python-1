...
def _main():
    ...
    # print(client.put("test", 0.5, timestamp=1))
    # print(client.put("test", 2.0, timestamp=2))
    # print(client.put("test", 0.3, timestamp=3))
    # print(client.put("test", 0.5, timestamp=3))
    # print(client.put("load", 3, timestamp=4))
    # print(client.put("load", 4, timestamp=5))

    print(client.put("k1", 0.25, timestamp=1))
    print(client.put("k1", 2.156, timestamp=2))
    print(client.put("k1", 0.35, timestamp=3))
    print(client.put("k2", 30, timestamp=4))
    print(client.put("k2", 40, timestamp=5))
    print(client.put("k2", 40, timestamp=5))
    print(client.get("*"))
